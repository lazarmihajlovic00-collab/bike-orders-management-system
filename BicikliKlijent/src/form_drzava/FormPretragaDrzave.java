...
import models.TableModelDrzave;

/**
 *
 * @author Mladja
 */
public class FormPretragaDrzave extends javax.swing.JDialog {

    public FormPretragaDrzave(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Pretraga drzave");
        TableModelDrzave model = new TableModelDrzave();
        Thread th = new Thread(model);
        th.start();
        tblDrzave.setModel(model);
    }
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        TableModelDrzave tm = (TableModelDrzave) tblDrzave.getModel();
        tm.setParametar(param);

        if (tm.getLista().isEmpty()) {
            JOptionPane.showMessageDialog(this,
                    "Sistem ne moze da pronadje drzavu po zadatim vrednostima!",
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        int row = tblDrzave.getSelectedRow();

        if (row >= 0) {
            Drzava d = ((TableModelDrzave) tblDrzave.getModel()).getSelectedDrzava(row);
            new FormDetaljiDrzave(this, true, d).setVisible(true);
        }
